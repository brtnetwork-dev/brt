...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      // Enable Node integration so the renderer can use CommonJS `require`
      // generated by the current TypeScript build (no bundler).
  ...
  // Helpful diagnostics if something goes wrong loading the page
